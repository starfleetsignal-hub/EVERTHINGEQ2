...
starts: Speak to a Tradeskill Tutorial NPC
prerequisite: '[[Tutorial: Learning to Harvest]]'
next_quest: '[[Tutorial: Countering Problems]]'
...
source:
  title: 'Tutorial: Forging Ahead'
  url: https://eq2.fandom.com/wiki/Tutorial:_Forging_Ahead
  history: https://eq2.fandom.com/wiki/Tutorial:_Forging_Ahead?action=history
  revision: 1907668
  revised: '2025-10-14T19:12:58Z'
...
1. Craft a [[Pristine simple candelabra|simple candelabra]] using your [[Carpenter]] skills
   - you receive 1 [[Basic Coal]] to power the [[Forge]] and [[Artisan essentials volume 1 (no-value)|artisan essentials volume 1]] containing 62 recipes
   - you will need 2 [[Tin cluster]], 1 [[Severed elm]], and 1 [[Root (harvest)|root]].
   - This recipe must be made using a Forge.
