...
starts: Hail [[Aymee Quickspoke]] at [[Dropship Landing Zone]] {{waypoint 1866, 453, 846}}
...
- Moors of Ykesha AA Quests
- Moors of Ykesha Quests
- Moors of Ykesha Solo Quests
- Quests
- Scalable Quests
- Solo Quests
...
source:
  title: Ship Out
  url: https://eq2.fandom.com/wiki/Ship_Out
  history: https://eq2.fandom.com/wiki/Ship_Out?action=history
  revision: 1825303
  revised: '2024-10-02T19:54:44Z'
...
1. I should seek out other Far Seas Trading Company Liaisons in the [[Moors of Ykesha]]
   - Liaison [[Mug (Moors of Ykesha)]] ([[Firmroot Moot]]) {{waypoint 163, -89, -462}}.  Wants you to finish the quest [[Fighting Swamp Foot]].
   - Liaison [[Varick Stoutheart]] ([[Tupta]]) {{waypoint -6, -54, 837}}.  Wants you to finish the quest [[Berry Good, Sir]].
   - Liaison [[Zubzub]] ([[Grobb]]) {{waypoint -444, -76, -911}}.  Wants you to finish the quest [[Buckle Down]].
   - Liaison [[Alden Strongaxe]] ([[The Overlook]]) {{waypoint -1119.49, -106.16, -272.71}}.  Wants you to finish the quest [[Midday Perk]].
   - Liaison [[Quinn Wobble]] ([[Shadowed Cleft]]) {{waypoint -1488, -1006, -37}}.  Wants you to finish the quest [[Rest for the Weary]].
   - Liaison [[Agata]] ([[Tillage Patch]]) {{waypoint -809, -917, -398}}.  Wants you to finish the quest [[Shards of Luclin]].
1. Return to [[Aymee Quickspoke]] at [[Dropship Landing Zone]] for your reward
...
- **To save time, consider bringing the following:**
    - A [[Portable Forge]] with at least one charge for the [[Buckle Down]] step in the quest. If not, there is a forge in Grobb at {{waypoint -362.60, -65.00, -1031.60}}
    - A [[Portable Sewing Table]] with at least one charge for the [[Fighting Swamp Foot]] step in the quest.
    - A [[Portable Cooking Set]] with at least one charge for the for [[Midday Perk]] step in the quest.
    - There is a [[Woodworking Table]] right next to [[Quinn Wobble]] when you are on the subquest, [[Rest for the Weary]], so a portable table is unnecessary.
...
- 10 [[Bristled pelt|bristled pelts]]
- 10 [[Cabilis cocoa bean|cabilis cocoa beans]]
- 10 [[Deklium cluster|deklium clusters]]
- 20 [[Ferrite cluster|ferrite clusters]]
- 10 [[Lichenclover root|lichenclover roots]]
- 10 [[Raw cranberry|raw cranberries]]
- 10 [[Redwood lumber]]

### Fuels

- 25 [[Smoldering coal|smoldering coal]]
- 25 [[Smoldering filament|smoldering filaments]]
- 25 [[Smoldering kindling]]
- 25 [[Smoldering sandpaper|smoldering sandpapers]]
...
1. Go to the Moors of Ykesha by druid ring, a wizard portal or taking the airship from Sinking Sands.
1. If this is your first time in the Moors, you may want to complete the quest [[A Cannon to Sail By]] first by talking to Ember Tizzlepring {{waypoint 1738, 451, 857}}. This quest is safe even for lower-level adventurers and will allow you to easily return to the Dropship Landing Zone.
1. Talk to Aymee Quickspoke {{waypoint 1869, 452, 845}} at the Dropship Landing Zone. If you hail her again, she will offer to teleport you to Firmroot Moot.
1. Talk to Mug in Firmroot Moot {{waypoint 163, -90, -462}} and he will give you a recipe for the leather boots and the special leather used to craft them. If you don't have a Portable Sewing Table you will need to fly back to the U.J.L., use the cannon to get back to the docks and craft at the crafting stations near Aymee. Don't try to use the crafting stations in Grobb or Tupta because you won't have the requisite faction with them and they will attack you. Hail Aymee for a teleport back to Mug. Talk to Mug again to complete the quest and then ask him for a teleport to Tupta.
1. Talk to Varick Stoutheart in Tupta {{waypoint -6, -55, 837}}, complete the quest and then hail him for a teleport to Grobb. This quest doesn't require crafting anything, you only need to click on six baskets full of berries in the immediate area. Talk to him again and he will offer to teleport you to Grobb.
1. Talk to Zubzub in Grobb {{waypoint -445, -76, -912}} and he will give you a recipe for the polished buckles and the special lead needed to craft them. You can use a Portable Forge, or you can use the nearby forge at {{waypoint -362, -65, -1032}}. Complete the quest and then talk to him again to teleport to the Overlook.
1. Talk to Alden Strongax at the Overlook {{waypoint -1120, -106, -271}} and he will give you a recipe for the brew and the "strong swill" needed to craft it. If you don't have a Portable Cooking Set, then you'll need to either return to the Dropship Landing Zone or take the balloon to Firmroot Moot and run to Grobb to use the stove there (remember that you can hail Aymee or Zubzub to return to the Overlook). Talk to Alden again and he will offer to teleport you to Shadowed Cleft.
1. Talk to Quinn Wobble in Shadowed Cleft {{waypoint -1490, -1006, -38}} and she will give you a recipe and the metal joints needed to craft the bunk beds. There is a woodworking table directly behind her you can use. After you have completed the quest, talk to her again and she will offer to teleport you to the Tillage Patch.
1. Talk to Agata in Tillage Patch {{waypoint -809, -918, -398}} and complete the quest to collect moon rocks. This is the quest where having water breathing will be helpful. They can be found underwater, on the riverbed in the general area around {{waypoint -898, -944, -191}}. To get back out of the water, you can use the large plant at {{waypoint -901, -934, -272}} as a ramp.
1. If you don't have a teleport or fast travel available to get back to the Dropship Landing Zone, take the balloon to back to the U.J.L. and return to the docks using the cannon. Talk to Aymee to complete the quest. You're done!

## Rewards

- Tradeskill experience
- At least 21g 46s 64c
- +750 faction with **Far Seas Supply Division**
- Your character can now obtain the Far Seas tradeskill quests on the [[Isle of Mara]]
  - Weekly solo mission quests by clicking on the table near Madria {{waypoint -94.21, 3.49, 104.75}}
  ...
  - Hourly group/solo mission quests from [[Madria Varas]]:
    - [[Emergency Portal Repairs]]
    - [[Supply Stocking]]
    - [[Clockwork Rescue]]
    - [[Shipyard Services]]
- You can also go back to:
  - Mug at Firmroot Moot and get the quest, [[Firmroot Moot Meet]]
  - Varick Stoutheart at Tupta and get the quest, [[Termite Troubles, Part I]]
  - Zubzub at Grobb and get the quest, [[Zubzub's Munchies, Part I]]
