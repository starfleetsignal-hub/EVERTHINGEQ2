...
journal_category: 'Crypt of Dalnir: Wizard''s Den'
starts: Chorch {{waypoint 600, -157, -632}}
prerequisite: '[[Dying to Have You]]'
next_quest: '[[Kunark Ascending: Resurrection Machination]]'
added_in: Kunark Ascending
categories:
- 'Crypt of Dalnir: Ritual Chamber (Solo) Quests'
- 'Crypt of Dalnir: Ritual Chamber (Solo) Solo Quests'
- 'Crypt of Dalnir: Wizard''s Den Quests'
...
source:
  title: Ghosts and Gooblins
  url: https://eq2.fandom.com/wiki/Ghosts_and_Gooblins
  history: https://eq2.fandom.com/wiki/Ghosts_and_Gooblins?action=history
  revision: 1803143
  revised: '2024-05-29T21:08:14Z'
  license: CC BY-SA 3.0
---

## Notes

- At the end of [[Crypt of Dalnir: Ritual Chamber (Solo)]], [[Chorch]] told you Sarnak Ghosts are bewitching the goblins and taking them to put them in cages.
- [[Chorch]] and [[Ollash]] can only be seen in the zone if you are on or have finished [[Dying to Have You]].
- The steps below are only the required steps for the quest not a walktrough of the complete zone.
- important! before "checking cages" equip Cloak of the Harvest or Glide, and have means of Escape available, as the cages suspended above a deep precipice are, of course, just out of reach.
...
1. Open the door and search the [[Mutation Hall]] {{waypoint 638, -58, 43}} for Ghawg.
   - Look for the roaming gooblin with a quest feather. Defeat it and bodyloot [[Ghawg's chokidai teeth necklace]].
   - **WARNING**: Make sure **EVERYONE** loots the body to get the necklace. You may only get one necklace for each kill. If so, the gooblin with the feather will respawn. Only the people who do not have the necklace already can see him, but he appears to become visible to the whole group after that person attacks him. If you forget to loot for everyone, you appear to be able to go back to the same place and wait for another one to respawn.
   - *If there are groups of gooblins, and you have trouble with them, use the [[Soothsayer's Bomb Dispenser (Solo)|Soothsayer's Bomb Dispenser]] to root one or two of the gooblins and move the unrooted ones away to more easily take them down. It is also possible to watch the paths of the gooblins in groups of three, hug a wall and pass them to get to the gooblin with the feather.*
1. Return to [[Wreek]] in the secret crypt {{waypoint 72, 26, -95}}.
   - *Evac works nicely here, or you can kill the Gooblin King and then use the purple teleporter.*

## Rewards

- [[Chokidai Tooth Wristwrap]]
- [[Bottom Shard of an Obulus Medallion]] - needed for [[Kunark Ascending: Resurrection Machination]]
- At least 1p 53g 9s
- 15960 status
