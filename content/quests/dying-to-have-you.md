...
journal_category: 'Crypt of Dalnir: Ritual Chamber'
starts: a shiny spot on the ground {{waypoint 600, -157, -632}}
prerequisite: '[[Hide and Wreek]]'
next_quest: '[[Ghosts and Gooblins]]'
added_in: Kunark Ascending
categories:
- 'Crypt of Dalnir: Ritual Chamber Quests'
...
source:
  title: Dying to Have You
  url: https://eq2.fandom.com/wiki/Dying_to_Have_You
  history: https://eq2.fandom.com/wiki/Dying_to_Have_You?action=history
  revision: 1874452
  revised: '2025-05-03T12:45:34Z'
  license: CC BY-SA 3.0
---

## Notes

- This quest leads into the [[Crypt of Dalnir: Ritual Chamber (Solo)]].
- You do not have to do the complete the instance to finish this quest. Follow the steps on the page devoted to this instance for details and steps not required by this quest, (*and therefore not included*,) here.

## Steps

1. *The ground shows signs of a struggle. Where was Ghawg dragged off to?*
1. Enter the [[Crypt of Dalnir: Ritual Chamber (Solo)]] at {{waypoint 790, -129, -584}}.
1. Go near "a Bloody Tooth goblin" on the floor {{waypoint -5, 26, -28}}. Automatic update. "Is it Ghawg?"
1. Investigate (by right clicking) the goblin on the floor.
   - *"Not Ghawg. But, I still think this is where he was taken."*, so continue to search for [[Ghawg]].
