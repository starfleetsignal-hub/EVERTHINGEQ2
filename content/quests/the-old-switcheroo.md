...
- The Coalition of Tradesfolke (Bad Faction)
...
source:
  title: The Old "Switcheroo"
  url: https://eq2.fandom.com/wiki/The_Old_"Switcheroo"
  history: https://eq2.fandom.com/wiki/The_Old_"Switcheroo"?action=history
  revision: 1632944
  revised: '2022-12-28T18:44:10Z'
...
[[West Freeport]] is the home base of [[The Freeport Militia (Faction)|the Freeport Militia]].  Additionally, West Freeport has several zone connections, with guards stationed at every zone.  Moreover, the path from [[The Thieves' Way]] to the [[The Coalition Factory]] is the roam path of 3 different guard/guard-pairs.

Do not choose this quest lightly, especially if the guards' level is not gray to you.

<sup>For more information regarding your character's safety on this quest, refer to the the talk page.</sup>
