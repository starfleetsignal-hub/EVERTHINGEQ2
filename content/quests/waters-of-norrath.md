---
title: Waters of Norrath
type: quest
level: '100'
difficulty: Heroic
zone: '[[*]]'
journal_category: Heritage
starts: Click on the water at {{waypoint 74, 4, 24}}
added_in: LU67
achievement_xp: true
categories:
- AA Quests
...
source:
  title: Waters of Norrath
  url: https://eq2.fandom.com/wiki/Waters_of_Norrath
  history: https://eq2.fandom.com/wiki/Waters_of_Norrath?action=history
  revision: 700577
  revised: '2017-05-08T16:08:35Z'
...
- Zone into [[Siren's Grotto: Alluring Embrace (Advanced Solo)]] or [[Siren's Grotto: Alluring Embrace (Heroic)]] from [[Cobalt Scar]].
- From the zone entry point, look in the water under the second waterfall on the right at {{waypoint 73, 5, 25}}.
- Right-click on the sparkling effect there and page through the dialog to be offered the quest.

## Steps

1. Find and speak to the siren [[Santii]] and she will tell you about her visions. She is in both [[Siren's Grotto: Alluring Embrace (Advanced Solo)]] and [[Siren's Grotto: Alluring Embrace (Heroic)]] under a waterfall at {{waypoint -439, -66, -110}}.
   - *Note: that in order to be able to reach this location, the first named in the zone (Shyneera) must be killed. However, the update can be obtained in an empty zone.*
1. Find the first spirit, [[A Spirit of Mists]] {{waypoint 530, -120, -180}}.- "I can see a great lake. A vast jungle creeps up to its shores, and a giant pillar rises in the distance." - ([[Fens of Nathsar]])).
1. Stop the lake's children from desecrating the waters.
   - Stop the first of the lake's children, [[A Bloodgill aquamancer]] {{waypoint 633, -183, 291}}. If the aquamancer is not up, clear [[A Bloodgill adherent|Bloodgill adherents]].
   - Stop the second of the lake's children, [[A Yha Lei cultist]] {{waypoint 936, -192, 648}}, in the center of a ring of [[A Yha Lei cultist|Yha Lei zealots]].
1. Return to the [[A Spirit of Mists|Spirit of Mists]].
1. Speak to [[Daleen Blackwood]] {{waypoint 240, -61, -224}}.
1. Disrupt the rituals inside [[Veksar: Waters of Norrath]] (a special version of Veksar). {{waypoint 631, -183, 290}}
   - *Note: Just about all the mobs in here can cast Aqueous Globe, a fast ticking high damage DoT preventable with water breathing.*
   - Stop the Yha-lei ritual. Kill An'Lill (98^^^) at {{waypoint 72, 2, -56}}.
...
1. Find the third spirit, [[A Spirit of the Deep]] {{waypoint 404, 21, -86}}.- "There are great cliffs that reach up to the sky. He looks for the remnants of a civilization lost to Norrath in the past. He remains near a few islands just off shore, ever seeking that which was lost." - ([[Butcherblock Mountains]] On the beach, at the base of the cliffs).

1. Locate artifacts, which appear as glowing clickies in the water, each protected by [[A Tavalan archeologist]].
...
Loot the chest to get your cloak.  If you forget, you'll have to kill Santii again.

## Rewards

- [[Cloak of Crystalline Waters (Fighter)]]
- [[Cloak of Crystalline Waters (Mage)]]
- [[Cloak of Crystalline Waters (Priest)]]
- [[Cloak of Crystalline Waters (Scout)]]
- Status
