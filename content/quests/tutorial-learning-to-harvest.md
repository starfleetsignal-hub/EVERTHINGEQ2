---
title: 'Tutorial: Learning to Harvest'
type: quest
...
source:
  title: 'Tutorial: Learning to Harvest'
  url: https://eq2.fandom.com/wiki/Tutorial:_Learning_to_Harvest
  history: https://eq2.fandom.com/wiki/Tutorial:_Learning_to_Harvest?action=history
  revision: 1907663
  revised: '2025-10-14T18:53:23Z'
  license: CC BY-SA 3.0
---

## Starting The Quest

This quest can be started by talking to one of the following NPCs:

1. Freeport: Speak to [[Vissa D`Dbth]] in West Freeport in [[The City of Freeport]]
1. Freeport: Speak to [[Ernest Ironthumb]] in [[The Ruins]]
1. Gorowyn: Speak to [[Rozokal Niba'mok]] at The Wards in [[Gorowyn]] ([[Timorous Deep]])
1. Gorowyn: Speak to [[Trainer Charkin Myli'Dok]] at Gorowyn Beach Outpost in [[Timorous Deep]]
1. Kelethin: Speak to [[Ikile Harmonia]] at Tunare's Pages in [[Kelethin]] ([[Greater Faydark]])
1. Kelethin: Speak to [[Trainer Eivarra Laceleaf]] in The Nursery in [[Greater Faydark]]
1. Neriak: Speak to [[Szinjss X'Vemtor]] at Dockside Markets in [[Neriak, City of Hate]]
1. Neriak: Speak to [[Trainer Zaktar D'Zhe'Virae]] in [[Darklight Wood]]
1. New Halas: Speak to [[Glin Hammerhelm]] at Ravens' Roost in [[New Halas]] ([[Frostfang Sea]])
1. New Halas: Speak to [[Trainer Hawk Dunlop]] at Pilgrim's Landing in [[Frostfang Sea]].
1. Qeynos: Speak to [[Calla Badgerbane]] in [[Oakmyst Forest]]
1. Qeynos: Speak to [[Jason Merrytoe]] near Claymore Plaza in [[Qeynos Capitol District]]
...
1. Harvest the following from a [[Tiers|Tier 1 Zone]]
   ...
   - 3 [[Root (harvest)|roots]] from clusters of roots
   - 3 [[Tin cluster|tin clusters]] from ore-containing rock
   - 3 [[Lead cluster|lead clusters]] from rock nodes
   - 3 [[Sunfish]] from schools of fish
   - 3 [[Jumjum]] from a garden or shrub node
   - 3 [[Rawhide leather pelt (no-value) (Version 1)|rawhide leather pelts]] from animal dens
1. Return them to the instructor. You do not have to return to the same instructor that you accepted the quest from.

## Rewards

- [[Disassembled Storage Box]]
- At least 81c
...
![School of fish in Greater Faydark, near the coast in the area you start in for that zone.](images/School_of_fish_faydark.png)
