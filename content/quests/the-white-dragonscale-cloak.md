...
starts: Read the book [[Sailing with Three Sheets to the Wind]]. {{waypoint -212.5, 14.3, 109}}
prerequisite: '[[The Triumph of Fear]]'
next_quest: '[[The Book of Thex (Quest)]]'
...
- Heritage Quests
- Heroic Quests
- 'Miragul''s Phylactery: Scion of Ice AA Quests'
- 'Miragul''s Phylactery: Scion of Ice Heroic Quests'
- 'Miragul''s Phylactery: Scion of Ice Quests'
- Quests
...
source:
  title: The White Dragonscale Cloak
  url: https://eq2.fandom.com/wiki/The_White_Dragonscale_Cloak
  history: https://eq2.fandom.com/wiki/The_White_Dragonscale_Cloak?action=history
  revision: 1868151
  revised: '2025-04-06T21:47:56Z'
...
You need +20,000 faction with the [[Guktan Guard (Faction)|Guktan Guard]] to proceed with step 4.
...
1. Speak to [[Rotheck Dragonforge]] {{waypoint 1803, 452, 962}} in [[Moors of Ykesha]] at the [[Dropship Landing Zone]].
   - Make sure you still have the book that starts the quest on you or he won't talk to you.
1. [[Rotheck Dragonforge|Rotheck]] sends you to gather the following items to make a necklace for him:
   - 12 [[Blue sapphire|blue sapphires]] from [[Nu'roga]] The entrance to Nu'Roga is just within the Mines of Nurga (Fens of Nathsar). The path to the mines (closest sokokar post is [[Drogan's Exiles]]) is at {{waypoint -371.32, -1.67, -1328.78}}.  Enter the tunnel and, a few feet in, turn right and follow the tunnel and climb up to enter Nu'roga . The sapphires drop from small wooden chests, so be sure to check these and not ignore them.
   - A [[Fay-formed ingot]] from [[Evernight Abbey]] (Loping Plains) [found at {{waypoint 105, -6, -120}} or at {{waypoint 151, -7, -120}}].
     - The ingot at {{waypoint 151, -7, -120}} is retrieved by clicking on a small jewelry case at the bottom of the bookshelf
...
1. Speak with [[Ward Glanral]] near the Tupta Balloon landing [[Moors of Ykesha]] at {{waypoint -55, -79, 467}}.
...
1. Obtain the following items:
   ...
   - A [[Swampsoaked amethyst]], purchased from [[Hopgip Goodsale]] at {{waypoint -38, -52, 839}} for 12g or [[Fippit Goodsale]] at {{waypoint 2, -55, 836}} or [[Valor Goodsale]] {{waypoint -80.59, -54.33, 816.56}}.  You must have +20,000 faction with the [[Guktan Guard (Faction)|Guktan Guard]] to purchase this. This is no-trade and only available on the merchant if you have the quest.  Note:  The "[[Guise of Pursuit]]" works for this faction requirement.
     - *Note: See the Talk page for ways to build faction with the Guktan Guard.*
1. Return to [[Ward Glanral]]. You must have both items in your inventory or you cannot proceed.
   - *Note: again, Ward advanced this step while having fire emeralds in the shared bank.*
1. Go to [[Befallen: Necrotic Asylum]] (Commonlands, enter the building at 633, -64, 797 and go to entrance at 564, -58, 916 to zone in) to find 6 [[Mana-infused black sapphire|sapphires]], updates from killing [[A shimmering miner|shimmering miners]], [[A shimmering excavator|shimmering excavators]] and [[A shimmering laborer|shimmering laborers]]. {{waypoint -126, -29, 66}} (Pull [[Captain Hamyr]] from a distance before proceeding down the hall to avoid adds.)
1. Return to [[Ward Glanral]] {{waypoint -54, -79, 471}} in Moors. (Smirk as he 'dings' on creation of the Kaladim Triple Sapphire pendant)
1. Now return to [[Rotheck Dragonforge]] (located at the dropship area in moors). He'll tell you the cloak was made for a royal family member of Thex, and suggests you track down the last owner: [[Queen Lenya Thex]] in [[Mistmyr Manor]] (not Mistmoore Castle).
