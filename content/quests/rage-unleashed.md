...
starts: Talk to [[Xilania Nevagon (GFay)|Xilania Nevagon]], near [[The Combine Spires]]. {{waypoint -496, 46, 271}}
...
1. When the crawler becomes "sated", right click-it to pick it up.
1. Return to Maertha Pulzer.
1. Go to the entrance of Mortartoe Mines and release the crawler hatchling from your inventory. {{waypoint -598, 153, -206}}
   - [[A hate-tainted crawler]] will spawn and slowly kill all the [[A Mortartoe miner|Mortartoe miners]] in the mine.
1. Return to Maertha Pulzer.
