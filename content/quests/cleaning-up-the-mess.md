...
starts: Speak to [[Serris]] behind [[Seafarer's Roost]] {{waypoint -258, -55, -11}}
prerequisite: '[[The Source of the Swords]]'
next_quest: '[[Turning Water Into Wine]]'
...
source:
  title: Cleaning Up the Mess
  url: https://eq2.fandom.com/wiki/Cleaning_Up_the_Mess
  history: https://eq2.fandom.com/wiki/Cleaning_Up_the_Mess?action=history
  revision: 635828
  revised: '2014-04-25T22:59:16Z'
...
1. Enter the [[Buccaneers' Hideout]] on Compassion Road in North Freeport {{waypoint -118, -53, -308}}
   ...
   - Kill [[Javvy]] (less two, double down) {{waypoint -23, 0, 6}}
   - Kill [[Fichman]] (less two, double down) {{waypoint -23, 0, -1}}
   - Kill 6 Seafury Buccaneers (less two, various one and double downs) throughout the zone
1. Approach [[Grimglot]] and [[Captain Siren]] on the top floor {{waypoint 0, 6, 3}}. Listen through their talk for auto-update
1. Speak to [[Lasarian Nasin]] in [[The Coalition of Tradesfolke]] in West Freeport {{waypoint 26, -18, 75}}
...
- At least 1p 15g (Scales with quest level; at level 23, 13s 2c)
- [[An Ornate Freeport Chandelier]]
