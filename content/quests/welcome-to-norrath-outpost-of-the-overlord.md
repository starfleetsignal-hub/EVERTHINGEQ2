---
title: Welcome to Norrath (Outpost of the Overlord)
type: quest
...
starts: Offered upon first arriving on the island.
prerequisite: '[[Tasks aboard the Far Journey]]'
next_quest: The Art of Combat (Outpost of the Overlord)|The Art of Combat
in_game_name: Welcome to Norrath
categories:
- Hallmark Quests
...
source:
  title: Welcome to Norrath (Outpost of the Overlord)
  url: https://eq2.fandom.com/wiki/Welcome_to_Norrath_(Outpost_of_the_Overlord)
  history: https://eq2.fandom.com/wiki/Welcome_to_Norrath_(Outpost_of_the_Overlord)?action=history
  revision: 1804098
  revised: '2024-06-20T07:37:21Z'
  license: CC BY-SA 3.0
---

This quest is part 1 of a 6-quest series in the [[Isle of Refuge Timeline]] for Freeport-Aligned characters.

## Description

"I should speak with Tayil N'Velex. She is at the entrance to Sythor's Spire in the center of the outpost." -- *Everquest II Journal*

## Steps

- Speak to [[Tayil N'Velex (Outpost of the Overlord)|Tayil N'Velex]] {{waypoint -8, -4, 177}} in front of [[Sythor's Spire]].
...
Speak to Tayil N'Velex, outside the entrance of Sythor's Spire in the center of the outpost.
