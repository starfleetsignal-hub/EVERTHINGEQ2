...
source:
  title: Food & Drink Depot (Large)
  url: https://eq2.fandom.com/wiki/Food_&_Drink_Depot_(Large)
  history: https://eq2.fandom.com/wiki/Food_&_Drink_Depot_(Large)?action=history
  revision: 689106
  revised: '2016-11-08T07:57:44Z'
...
- This amenity does not has a [[Guild Level]] minimum of 100.
- The regualr [[Food & Drink Depot]] has **no** minimum.
- This amenity is available for all types of [[Guild Hall|Guild Halls]].

## Amenity Details

The Food & Drink Depot (Large) holds 400 stacks of different [[Food|food]] and [[Drink|drink]] items.

- Each stack can hold 99,999 of that item.
- Once placed into the depot, the resale value is removed, along with the name of the artisan who crafted the item.
