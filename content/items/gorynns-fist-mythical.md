...
- Equipment
- Fists (Weapon Type)
- Hardened Skin (Equipment)
- Main Hand Slashing (Equipment Type)
- Mythical Equipment
- Potency (Equipment)
- Primary (Inventory Slot)
- Strike of Anger (Equipment)
- Tier 9 Equipment
- Unyielding Resolve (Equipment)
source:
  title: Gorynn's Fist (Mythical)
  url: https://eq2.fandom.com/wiki/Gorynn's_Fist_(Mythical)
  history: https://eq2.fandom.com/wiki/Gorynn's_Fist_(Mythical)?action=history
  revision: 1910303
  revised: '2025-11-10T18:54:45Z'
