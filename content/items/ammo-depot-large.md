...
source:
  title: Ammo Depot (Large)
  url: https://eq2.fandom.com/wiki/Ammo_Depot_(Large)
  history: https://eq2.fandom.com/wiki/Ammo_Depot_(Large)?action=history
  revision: 689098
  revised: '2016-11-08T07:49:18Z'
...
- The standard [[Ammo Depot]] has **no** guild minimum level.
- This amenity is available for all types of [[Guild Hall|Guild Halls]].

## Amenity Details

The Ammo Depot (Large) holds 200 stacks of different ammo, like [[Feyiron shuriken]], [[Iron bodkin arrow|Iron bodkin arrows]], etc.

- Each stack can hold 99,999 of that item.
- Both the regular and large depots are identical.*Both the regular and large depots are visually identical.
