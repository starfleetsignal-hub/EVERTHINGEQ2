...
description: This item can be placed on the floor in any house type.<br><br>This is a mastery tome.  Use the knowledge contained within to gain a basic understanding of the tactics to use against the chosen foe.
obtained_from: '*[[Lore and Legend: Drakota]] *Click a stone bench on the right as you face [[The Temple of Scale]] {{waypoint -20, 47, -173}}'
starts_quest: '[[Lore and Legend: Drakota]]'
item_link: \aITEM -2001329186 -112900892:Drakota\/a
aliases:
- Drakota (QuestReward) (no-value no-trade)
categories:
- Book (Item Subtype)
- Books
- Census Credits
...
- Lore and Legend (Book Series)
source:
  title: Drakota (QuestReward)
  url: https://eq2.fandom.com/wiki/Drakota_(QuestReward)
  history: https://eq2.fandom.com/wiki/Drakota_(QuestReward)?action=history
  revision: 2001664
  revised: '2026-05-09T13:02:54Z'
...
Powerful creatures with powerful bodies, drakota have the gift of flight and are considered some of the fastest flyers of all dragonkind.
