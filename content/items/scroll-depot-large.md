---
title: Scroll Depot (Large)
type: item
item_kind: House Item
item_subtype: Guild Hall Amenity
obtained_from: 'Available only within [[Guild Hall|Guild Halls]] *Purchase cost: 25p 10,000,000 status *Upkeep cost: 45g 45,000 status *You must be a guild leader or trustee to purchase it. *This can only be placed in the guild hall.'
categories:
...
source:
  title: Scroll Depot (Large)
  url: https://eq2.fandom.com/wiki/Scroll_Depot_(Large)
  history: https://eq2.fandom.com/wiki/Scroll_Depot_(Large)?action=history
  revision: 1023747
  revised: '2020-02-09T17:41:42Z'
...
- The regular [[Scroll Depot]] has **no** minimum.
- This amenity is available for all types of [[Guild Hall|Guild Halls]].

## Amenity Details

The Scroll Depot (Large) holds 5,000 stacks of spell and combat scrolls.
