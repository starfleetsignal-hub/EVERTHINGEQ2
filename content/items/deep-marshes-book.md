...
obtained_from: '[[Deep Marshes (Quest)|Deep Marshes]]'
item_link: \aITEM 178595102 795735593:Deep Marshes\/a
image: images/Deep_Marshes.png
categories:
- Book (Item Subtype)
- Books
- Census Credits
...
- Items
- Quest or Series (Book Series)
source:
  title: Deep Marshes (Book)
  url: https://eq2.fandom.com/wiki/Deep_Marshes_(Book)
  history: https://eq2.fandom.com/wiki/Deep_Marshes_(Book)?action=history
  revision: 1722811
  revised: '2023-04-30T18:49:23Z'
...
They were a tired, footsore and bedraggled group when they reached Freeport at last. Though many had not survived the harsh crossing, between the heat and the sand giants, more than three-quarters of Guruup's unit was still intact. The frogloks paused briefly to take rooms at a local inn and to cleanse themselves, then they hurried to gain an audience with the Overlord.
