---
title: Voidcry (Armor Set)
type: page
expansion: The Shadow Odyssey
aliases:
- Aramid Voidcaller (Armor Set)
categories:
- Armor Sets
- Conjuror Equipment
...
source:
  title: Voidcry (Armor Set)
  url: https://eq2.fandom.com/wiki/Voidcry_(Armor_Set)
  history: https://eq2.fandom.com/wiki/Voidcry_(Armor_Set)?action=history
  revision: 461338
  revised: '2010-03-19T15:54:57Z'
...
<br>
This is the TSO Armor Set (Tier 2) for: [[Summoner|Summoners]] ( ) that can be obtained via the [[Void Shard Mission System]].
