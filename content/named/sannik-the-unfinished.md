...
location: '[[Corrosive Chamber]] {{waypoint -128.60, -54.28, -315.97}}'
drops:
- '[[Armshroud of Sannik]]'
- '[[Horrific Chestguard]]'
- '[[Sannik''s Link]]'
...
categories:
- 'Emperor Atrebe''s Laboratory: The Fabled City of Kor-sha Named Monsters'
...
source:
  title: Sannik the Unfinished
  url: https://eq2.fandom.com/wiki/Sannik_the_Unfinished
  history: https://eq2.fandom.com/wiki/Sannik_the_Unfinished?action=history
  revision: 1853833
  revised: '2025-01-20T03:58:11Z'
  license: CC BY-SA 3.0
---

## Strategy

Has a knockback and two AOE's - Intense Hatred (Heat DD w/ DoT) and Mutant Strike (Disease DD w/ DoT).
